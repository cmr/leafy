...
describe("router", function()
	...
	it("fails gracefully", function()
		assert.error(function() route() end)
		assert.error(function() route("bogus") end)
		assert.error(function() route(42) end)
		assert.error(function() route(routing_table) end)
		assert.error(function() route(routing_table, 42) end)
	end)
end)
